...
cmd:option('-model', 'models/zf.lua')
-- cmd:option('-name', '/disk/bingbin/faster-rcnn-torch/imgnet', 'experiment name, snapshot prefix') 
cmd:option('-name', 'output_mine/pnet/double_sorted_imgnet', 'experiment name, snapshot prefix') 
...
-- cmd:option('-restore', 'output_mine/pnet/zf_imgnet_042000.t7', 'network snapshot file name to load')
