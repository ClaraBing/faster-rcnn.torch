...
local RPNLocalizer = torch.class('RPNLocalizer')

function RPNLocalizer:__init(outnode)
...
end -- RPNLocalizer:init

function RPNLocalizer:inputToFeatureRect(rect, layer_index)
...
end -- RPNLocalizer:inputToFeatureRect

function RPNLocalizer:featureToInputRect(minX, minY, maxX, maxY, layer_index)
  layer_index = layer_index or #self.layers
