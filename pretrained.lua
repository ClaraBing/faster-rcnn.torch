...
cmd:option('-name', 'output_mine/pnet/pretrain_double_lr4_10k_imgnet', 'experiment name, snapshot prefix') 
...
function pnet_training(cfg, model_path, snapshot_prefix, training_data_filename, network_filename)
  ...
  local batch_iterator = BatchIterator.new(model, training_data, true) -- last entry = true: i.e. randomize
