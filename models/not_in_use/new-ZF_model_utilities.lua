...
function create_proposal_net(shared_layers, prop_layers)
  ...
  for i,a in ipairs(prop_layers) do
    table.insert(proposal_outputs, AnchorNetwork(shared_layers[a.input].filters, a.n, a.kW)(conv_outputs[a.input]))
